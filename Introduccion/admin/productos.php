        ...
        ?>
          ...
          <form action="./php/insertarProducto.php" class="row" method="POST" enctype="multipart/form-data">
              ...
              <div class="col-4">
                  ...
                  <input type="number" class="form-control" placeholder="Inserta el precio" name="precio" requiered>
              </div>
              <div class="col-4">
              ...
              <div class="col-4">
                  ...
                  <input type="file" class="form-control" placeholder="Inserta la imagen" name="imagen" required>
              </div>
      ...
      <table class="table">
          ...
          <tbody>
              ...
              <tr>
                  ...
                  <td>
                      <img src="./img/productos/<?php echo $fila['imagen']; ?>" widt="50px" height="50px "halt="">
