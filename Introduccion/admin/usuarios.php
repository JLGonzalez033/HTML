      ...
      <div class="card">
        ...
        if(isset($_GET['succes'])){
            ...
            <div class="alert alert-succes">
              <b>Listo:</b> <?php echo $_GET['succes'];?>
          </div>
        <?php
        }
        ?>
          ...
          <form action="./php/insertarUsuario.php" class="row" method="POST">
              <div class="col-4">
                  ...
                  <input type="text" class="form-control" placeholder="Insertar tu nombre" name="nombre" id="txtNombre" required>
              </div>
              <div class="col-4">
                  <label for="">Apellido</label>
                  <input type="text" class="form-control" placeholder="Insertar tu Apellido" name="ap" requiered>
              </div>
              <div class="col-4">
                  <label for="">Email</label>
                  <input type="email" class="form-control" placeholder="Insertar tu email" name="email" required>
              </div>
              <div class="col-4">
                  <label for="">Password</label>
                  <input type="password" class="form-control" placeholder="Insertar tu password" name="p1" required>
              </div>
              <div class="col-4">
  ...
  <div class="modal fade" id="modal-editar">
        <div class="modal-dialog">
          <div class="modal-content ">
            ...
            <div class="col-12">
                  <label for="">Nombre</label>
                  <input type="text" class="form-control" placeholder="Insertar tu nombre" name="nombre" id="nombreEdit" required>
              </div>
              <div class="col-12">
                  <label for="">Apellido</label>
                  <input type="text" class="form-control" placeholder="Insertar tu Apellido" name="ap" requiered id="apEdit">
              </div>
              <div class="col-12">
                  <label for="">Email</label>
                  <input type="email" class="form-control" placeholder="Insertar tu email" name="email" required id="emailEdit">
              </div>
              <div class="col-12">
                  <label for="">Password</label>
                  <input type="password" class="form-control" placeholder="Insertar tu password" name="p1">
              </div>
              <div class="col-12">
                  <label for="">Confirmar Password</label>
